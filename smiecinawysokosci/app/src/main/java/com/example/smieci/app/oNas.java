...
public class oNas extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.o_nas, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.o_nas) {/*Intent myIntent = new Intent(this, oNas.class);
            startActivity(myIntent);*/

        } else if (id == R.id.spot) {
            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=y-baYo3OmH8"));
            startActivity(browserIntent);
