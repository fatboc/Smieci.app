...
public class vrMetropol extends AppCompatActivity {

    private static final String TAG = vrMetropol.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vr1);
   ...
   /* TextView sourceText = (TextView) findViewById(R.id.source);
    ...
    class ImageLoaderTask extends AsyncTask<Pair<Uri, Options>, Void, Boolean> {
        ...
        protected Boolean doInBackground(Pair<Uri, Options>... fileInformation) {
            ...
            if (fileInformation == null || fileInformation.length < 1
                ...
                try {
                    istr = assetManager.open("metropol.jpg");
    ...
    private class ActivityEventListener extends VrPanoramaEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    vrMetropol.this, "Error loading pano: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
